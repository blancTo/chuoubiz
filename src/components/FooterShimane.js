  ...
  return (
    <>
        <footer id="footer">
            ...
            <div id="footer_btn">
                <ul>
                <li className="mail"><Link to="/shimane/contact/"><StaticImage src="../img/btn_mail.png" alt="メールで相談" /></Link></li>
            ...
            <div className="links dsp_hp">
                <ul>
                <li><Link to="https://www.chuou.biz/shimane/">ホーム</Link></li>
                <li><Link to="/shimane/contact/">お問い合わせ</Link></li>
                <li><Link to="/policy/">個人情報保護に関する取り組み</Link></li>
                </ul>
            </div>
            {/* ここまで */}
            <p id="copyright">Copyright &copy; 2022 株式会社中央リサーチ島根. All Rights Reserved.</p>
        </footer>
