  ...
  return (
    <>
        <header id="header" className="cf">
            <h1>{props.h1title}</h1>
            <div id="sticky">
            <p className="title"><Link to="/ehime/"><span className="fs dsp_smt">{props.pagetitle}</span><StaticImage src="../img/ehime/title.png" alt="株式会社中央リサーチ愛媛" /></Link></p>
            ...
            <ul className="g_menu ehime">
                ...
                <li><Link to="/ehime/jirei/">調査事例</Link></li>
            ...
            <label for="overlay-input" id="overlay-button">
				...
				<li>
                    <input id="smpnav-check5" class="smpnav-check5" type="checkbox" />
                    <label class="smpnav-label" for="smpnav-check5">調査項目<FontAwesomeIcon icon={faPlus} /></label>
                    <div className='smpnav-content'>
                    <ul>
                    <li><Link to="/ehime/about/#uwaki">浮気・不倫調査</Link></li>
                    <li><Link to="/ehime/about/#sokou">素行調査</Link></li>
                    <li><Link to="/ehime/about/#saiban">裁判証拠収集</Link></li>
                    <li><Link to="/ehime/about/#kekkon">結婚・身上調査</Link></li>
                    <li><Link to="/ehime/about/#iede">家出・所在調査</Link></li>
                    <li><Link to="/ehime/about/#stalker">嫌がらせ・ストーカー対策</Link></li>
                    <li><Link to="/ehime/about/#touchouki">盗聴器発見調査</Link></li>
                    <li><Link to="/ehime/about/#kagaku">科学的調査</Link></li>
					</ul>                        
                    </div>					
				</li>				
				<li>
				...
				<li><Link to="/ehime/voice/">お客様の声</Link></li>        
				<li><Link to="/ehime/jirei/">調査事例紹介</Link></li>
				<li><Link to="/ehime/company/">会社概要</Link></li>
				<li><Link to="/ehime/price/">料金表</Link></li>
				<li><Link to="/ehime/contact/">お問い合わせ</Link></li>
			</ul>
