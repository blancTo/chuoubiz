  ...
  return (
    <>
        <header id="header" className="cf">
            <h1>{props.h1title}</h1>
            <div id="sticky">
            <p className="title"><Link to="/ehime/"><span className="fs dsp_smt">{props.pagetitle}</span><img src="../img/ehime/title.png" alt="株式会社中央リサーチ愛媛" /></Link></p>
            ...
            <label htmlFor="overlay-input" id="overlay-button">
				...
				<li>
                    ...
                    <label className="smpnav-label" htmlFor="smpnav-check5">調査項目<FontAwesomeIcon icon={faPlus} /></label>                    
