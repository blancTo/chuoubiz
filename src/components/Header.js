  ...
  return (
    <>
        <header id="header" className="cf">
            <h1>{props.h1title}</h1>
            <div id="sticky">
                <p className="title"><Link to="/"><span className="fs dsp_smt">家庭裁判所前にある探偵事務所</span><img src="/img/title.png" width={430} height={36} alt="株式会社中央リサーチ" /></Link></p>
                ...
                <p className="line"><Link to="https://line.me/R/ti/p/65gpK3qcDs" rel="nofollow noopener noreferrer" target="_blank"><img src="../img/line.png" width={58} height={58} alt="LINE" /></Link></p>
                </div>
            </div>
            ...
            <nav id="menu">
                ...
                <li className="dsp_hp">
                    <Link to="/" className="child">法人様向けプラン</Link>
                    <ul className="dropdwn_menu">
            ...
            <label for="overlay-input" id="overlay-button">
				...
				<li>
                    <input id="smpnav-check1" class="smpnav-check1" type="checkbox" />
                    <label class="smpnav-label" for="smpnav-check1">調査項目<FontAwesomeIcon icon={faPlus} /></label>
				...
				<li>
                    <input id="smpnav-check2" class="smpnav-check2" type="checkbox" />
                    <label class="smpnav-label" for="smpnav-check2">法人様向けプラン<FontAwesomeIcon icon={faPlus} /></label>
                    <div className='smpnav-content'>
					<ul>
                        <li><Link to="/corporation/#credit-check">企業信用調査</Link></li>
                        <li><Link to="/corporation/#employment-Survey">採用調査</Link></li>
