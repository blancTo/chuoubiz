  ...
  return (
    <>
      ...
      <div id="wrap">
        ...
        <HeaderShimane h1title="島根で浮気調査なら55年の実績と信頼｜島根の探偵社、中央リサーチ島根" pagetitle="JR松江駅前にある探偵事務所" />
        ...
        <section id="container" className="cf">
            ...
            <div id="menu_sp" className="dsp_tbs shimane">
            <ul>
            ...
            <div id="about"><div id="shimane_about" className="main bg_wide pt pb">
            ...
            <div id="top_evidence">
                ...
                <p className="link mp"><Link to="../sample.html">調査報告書サンプルはコチラ</Link></p>
                </div>
            </div>
            ...
            <div id="top_shimane" className="bg_wide pb">
                ...
                <p className="map"><Link to="https://goo.gl/maps/2rJuQAmFp2RPNTJq9" rel="nofollow" target="_blank"><img src="../../img/shimane/map.png" loading="lazy" alt="" /></Link></p>
                </div>
                <div className="photo">
...
export const Head = () => (
    <>
        <Seo
        title="島根で浮気調査なら55年の実績と信頼｜島根の探偵社、中央リサーチ島根"
        description="中央リサーチ島根は｢浮気調査が最も得意｣な探偵社であり、裁判証拠収集ならお任せください!!ご相談は無料です。島根県公安委員会探偵業届出済で、浮気調査は信頼と実績ある当社にご相談ください！プロの探偵が全力でお悩みを解決いたします！高い追跡技術を持つ中央リサーチ島根が浮気・不倫の現場を突き止めます。"
