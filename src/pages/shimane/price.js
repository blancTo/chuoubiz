...
const price = () => {
    ...
    return (
        <>
        <Seo
            title2="探偵事務所調査料金表｜総合探偵社中央リサーチ島根"
            description="当探偵社ではお客様を不安にさせる様なあいまいな料金表示や請求方法は一切行いません。"
            keyword="探偵,島根,料金表,中央リサーチ島根"
            />
            <div id="wrap">
                <HeaderShimane h1title="調査料金について" pagetitle="JR松江駅前にある探偵事務所" />
                <SubpageTitle subtitle={pagemeta.title} id={pagemeta.slug} />
                <Breadcrumb subtitle={pagemeta.title} />
                <Layout>
                    <div id={pagemeta.slug} className="main">

                            <div id="price_msg" className="bg_wide pb pt mb">
                                <div className="in">
                                <div className="txt">
                                ...
                                <p className="photo"><StaticImage src="../../img/shimane/price/img.png" alt="" /></p>
                                </div>
                            </div>
                            ...
                            <div className="mb box_flex">
                                ...
                                <table className="tbl">
                                    ...
                                    <tr>
                                        <th>家族事項</th>
                                        <td>１家族<br className="dsp_smt" />につき</td>
                                        <td><b className="blue2 fm">5万円</b>税込 55,000円</td>
                                    </tr>
                                    </tbody></table>
                                </div>
                                <div className="box">
                                ...
                                <br className="dsp_hpt" />
                                <div className="note">
                                    <p className="attention nm">※調査料金以外に諸経費（車両代、保険料、燃料、高速代、機材使用料、通信費、宿泊代、報告書作成費、入店調査実費等）が別途必要になります。</p>
                                    <br />
