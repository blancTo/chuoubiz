                ...
                <Layout>
                    <div id={pagemeta.slug} className="main">
                        ...
                        <div className="pb">
                            ...
                            <form action="https://ssgform.com/s/GJmU4VO0qePD" method="post" id="mailform">
                            ...
                            <table className="tbl">
                                ...
                                <tr>
                                    <th>郵便番号</th>
                                    <td><input type="text" name="郵便番号" size={10} className="disabled wno" />&nbsp;
                                    <input type="button" defaultValue="〒から住所を自動入力" onclick="mfpc('mailform','郵便番号','住所');" /></td>
                                </tr>
                                <tr>
                                    <th>住所</th>
