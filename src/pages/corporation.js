                ...
                <Layout>
                    <div id={pagemeta.slug} className="main">
                                ...
                                <div id="credit-check" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img01.jpg" alt="" /></p>
                                ...
                                <div id="employment-Survey" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img02.jpg" alt="" /></p>
                                ...
                                <div id="market-research" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img03.jpg" alt="" /></p>
                                ...
                                <div id="employee-behavior" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img04.jpg" alt="" /></p>
                                ...
                                <div id="crisis-management" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img05.jpg" alt="" /></p>
                                ...
                                <div id="traffic-accident" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img06.jpg" alt="" /></p>
                                ...
                                <div id="intellectual-property" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img07.jpg" alt="" /></p>
                                ...
                                <div id="competitor-Survey" className="pad_anchor">
                                    <div className="bg_dia">
                                        <dl>
                                            ...
                                            <dd>
                                            <p className="img"><StaticImage src="../img/corporation/img08.jpg" alt="" /></p>
                        ...
                        <div className="special pt pb">
                            ...
                            <div className="box">
                                <p className="img"><StaticImage src="../img/corporation/contact.jpg" alt="" /></p>
                                <div className="info">
