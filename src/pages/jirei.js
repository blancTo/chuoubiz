            ...
            <Breadcrumb subtitle={pagemeta.title} />
                <Layout>
                    <div id={pagemeta.slug} className="main">
                        ...
                        <div className="bg_blue bg_wide pt pb">
                            <div className="wrap">
                            ...
                            <dl className="plan">
                                <dt><span className="mp">浮気・不倫調査</span><Link to="/fickleness/">浮気・不倫調査について詳しくはこちら »</Link></dt>
                                <dd>
                                <p className="txt">夫は残業と言いながら帰宅が遅い日々が続いていました。何かあるかも？と、夫の携帯を見たら浮気相手と思われる女性とのメールを見ました。<br />
                                    話し合う為にも動かぬ証拠と浮気相手がどんな人物か知りたい。</p>
                                <div className="bg_gray">
                                    <p className="nm">浮気する可能性の高い給料日後や、残業が多い日等の行動予測をしていただき、わずかな調査時間で浮気の証拠と相手女性の帰宅先が判明しました。<br />
                            ...
                            <dl className="plan">
                                <dt><span className="mp">素行調査</span><Link to="/behavior/">素行調査について詳しくはこちら »</Link></dt>
                                <dd>
                                <p className="txt">厳しい時代の中、営業社員の業績が上がらないことで、悩んでいました。このままでは会社が倒産してしまうという不安がよぎり、思い切って相談してみました。</p>
                                <div className="bg_gray">
                                    <p className="nm">相談員の適正なアドバイスから、従業員の勤務時間中の行動を確認した結果、まったく仕事をしていないことが判明しました。証拠が有ることで、トラブルなく、この営業社員を解雇することが出来ました。早く事実確認でき、意欲のない営業社員が居なくなることで職場の雰囲気も良くなりました。</p>
                                </div>
                                </dd>
                            </dl>
                            <dl className="plan">
                                <dt><span className="mp">浮気・不倫調査</span><Link to="/fickleness/">浮気・不倫調査について詳しくはこちら »</Link></dt>
                                <dd>
                                <p className="txt">夫が急に離婚しようと言い出し、その原因はと問いただすと、こちらばかり責められます。もしかして愛人がいるのでは？と疑問だったのです。</p>
                                <div className="bg_gray">
                                    <p className="nm">的確なアドバイスを頂き、行動調査を依頼した結果、離婚に係わる浮気の動かぬ証拠が撮れました。有能な弁護士さんも紹介され、おかげで慰謝料、親権、養育費等について、有利に進めることが出来ました。これからは気持ちを切り替えて、一からがんばります。</p>
                                </div>
                                </dd>
                            </dl>
                            <dl className="plan">
                                <dt><span className="mp">家出・所在調査</span><Link to="/whereabouts/">家出・所在調査について詳しくはこちら »</Link></dt>
                                <dd>
                                <p className="txt">娘が家出をしてしまい、眠れない日々を過ごしています。今、何処で何をしているのか、気になります。</p>
                                <div className="bg_gray">
                                    <p className="nm">どうしてもっと早く相談しなかったのかと思います。私たちだけではどう対応していいのかわかりませんでしたが、探偵さんの的確な調査により、探し出すことができました。この先やらなければならないことを一からやり直すつもりで、娘共々頑張っていきたいと思っています。</p>
                                </div>
                                </dd>
                            </dl>
                            <dl className="plan">
                                <dt><span className="mp">浮気・不倫調査</span><Link to="/fickleness/">浮気・不倫調査について詳しくはこちら »</Link></dt>
                                <dd>
                                <p className="txt">交際相手には女性の影が？「いま付き合っている相手と別れた方がよいのか？」と悩んでいます。しかし自分が別れを持ち出すはっきりとした判断材料がありません。<br />
                                    自分の気持ちに、ふん切りを付けるためにも事実関係を確認したいのです。</p>
                                <div className="bg_gray">
                                    <p className="nm">相談員のアドバイスで数日間、交際相手と会わないようにして、彼の休日を中心に素行を確認してもらいました。その結果、別の女性との交際が発覚したのです。<br />
                            ...
                            <dl className="plan">
                                <dt><span className="mp">素行調査</span><Link to="/behavior/">素行調査について詳しくはこちら »</Link></dt>
                                <dd>
                                <p className="txt">離婚した元妻とは、定期的に連絡をとって子どもの近況報告は受けています。実際に会うことで子どもが迷ってはいけませんので、会う勇気もありません。<br />
                                    しかし、「元妻の報告内容は本当なのか？」「虐待を受けていないか？」「学校でいじめられていないか？」「元気に学校へ通っているか？」等、気になります。<br />
                                    子供の父には変わりないのです。離婚したと言えども心配です。</p>
                                <div className="bg_gray">
                                    <p className="nm">元妻の現住所はあらかじめ聞いていましたので、その情報をもとに、子どもの生活実態（虐待・いじめの有無、健康面等）を確認していただきました。<br />
