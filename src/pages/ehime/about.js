...
const about = () => {
    ...
    return (
        <>
            ...
            <Seo
            title2="調査項目｜総合探偵社中央リサーチ愛媛"
            description="愛媛の興信所・探偵社の中央リサーチ愛媛の調査項目について。浮気調査を最も得意とする探偵社です。ご依頼者様の心のお悩みを解決し、平穏な日々を取り戻せるよう全力を尽くします。浮気調査に多くの実績を持つ当社にお任せください。"
            keyword="調査項目,探偵,愛媛,興信所,浮気調査,中央リサーチ愛媛"
            />
            <div id="wrap">
