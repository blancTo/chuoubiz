...
const contact = () => {
    ...
    return (
        <>
            <Seo
            title2="ご相談、お問合せはこちら｜総合探偵社中央リサーチ愛媛"
            description="愛媛の探偵社「中央リサーチ愛媛」ではどのようなお問合せにも対応致します。お気軽にご連絡ください。"
            keyword="探偵,愛媛,問合せ,中央リサーチ愛媛"
            />
            <div id="wrap">
                <HeaderEhime h1title="ご相談、お問い合わせについて" pagetitle="松山市民病院前にある探偵事務所" />
                ...
                <Layout>
                    <div id={pagemeta.slug} className="main">
                        ...
                        <div id="contact_line" className="cf pb">
                            ...
                            <p><StaticImage src="../../img/contact/line_logo.png" width={151} height={41} alt="" /></p>
                            <p className="b fm">LINEからお問い合わせできます！</p>
                            <div className="dsp_hp">
                            <p className="img_rit"><StaticImage src="../../img/contact/qr.gif" width={170} height={170} alt="" /></p>
                        ...
                        <div id="contact_tel" className="pb">
                            ...
                            <div className="msg_box02">
                                ...
                                <dl className="box02_flex">
                                    ...
                                    <a href="tel:0120-30-6630" className="tel tel_m sans"><StaticImage src="../../img/free.png" alt="フリーダイヤル" />0120-30-6630</a>
                                    <p className="msg_txt04">女性相談員ご希望の方はこちら</p>
                                    <a href="tel:0120-20-3399" className="tel sans"><StaticImage src="../../img/free.png" alt="フリーダイヤル" />0120-20-3399</a>
                                    </dd>
                                </dl>
                        ...
                        <div className="pb">
                            ...
                            <form action="https://ssgform.com/s/B6qy2MvQCDGK" method="post" id="mailform">
