...
const price = () => {
    ...
    return (
        <>
        <Seo
            title2="探偵事務所調査料金表｜総合探偵社中央リサーチ愛媛"
            description="当探偵社ではお客様を不安にさせる様なあいまいな料金表示や請求方法は一切行いません。"
            keyword="探偵,愛媛,料金表,中央リサーチ愛媛"
            />
            <div id="wrap">
                <HeaderEhime h1title="調査料金について" pagetitle="松山市民病院前にある探偵事務所" />
                ...
                <Layout>
                    ...
                    <div id="price_msg" className="bg_wide pt pb mb">
                        ...
                        <p className="photo"><StaticImage src="../../img/ehime/price/img.png" alt="" /></p>
                        </div>
                    </div>
