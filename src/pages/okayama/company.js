                ...
                <Layout>
                    <div id={pagemeta.slug} className="main pb">
                        <div className="bg pt pb bg_wide">
                            ...
                            <p className="nm rit">株式会社中央リサーチ　代表取締役<img src="../../img/okayama/company/name.png" alt="樋之本 浩章" /></p>
                            </div>
                        </div>
                        <div className="pt">
                            <h3 className="headline">会社概要</h3>
                            <div className="box">
                            <div className="in dsp_hpt"><img src="../../img/okayama/company/img05.jpg" alt="" /></div>
                            <table>
                                <tbody><tr>
                            ...
                            <div className="photo">
                            <dl>
                                <dt><img src="../../img/okayama/company/img01.jpg" alt="" /></dt>
                                <dd>
                            ...
                            <dl>
                                <dt><img src="../../img/okayama/company/img02.jpg" alt="" /></dt>
                                <dd>
                                <p className="cen blue b nm">表彰状</p>
                                </dd>
                            </dl>
                            <dl>
                                <dt><img src="../../img/okayama/company/img03.jpg" alt="" /></dt>
                                <dd>
                                <p className="cen blue b nm">組合員証</p>
                                </dd>
                            </dl>
                            <dl>
                                <dt><img src="../../img/okayama/company/img04.jpg" alt="" /></dt>
                                <dd>
                                <p className="cen blue b nm">委嘱状</p>
                                </dd>
                            </dl>
                            <dl className="dsp_smt">
                                <dt><img src="../../img/okayama/company/img05.jpg" alt="" /></dt>
                                <dd>
