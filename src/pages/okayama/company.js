...
const company = () => {
    ...
    return (
        <>
        <Seo
            title2="岡山の総合探偵社中央リサーチ会社概要について"
            description="長年の実績を持つ岡山の探偵社「中央リサーチ岡山」の会社概要です。"
            keyword="中央リサーチ,岡山,会社概要,中央リサーチ岡山"
            />
            <div id="wrap">
                <HeaderOkayama h1title="会社概要について" pagetitle="岡山駅より徒歩5分の探偵事務所" />
                ...
                <Layout>
                    <div id={pagemeta.slug} className="main pb">
                        <div className="bg pt pb bg_wide">
                            ...
                            <p className="nm rit">株式会社中央リサーチ　代表取締役<StaticImage src="../../img/okayama/company/name.png" alt="樋之本 浩章" /></p>
                            </div>
                        </div>
                        <div className="pt">
                            <h3 className="headline">会社概要</h3>
                            <div className="box">
                            <div className="in dsp_hpt"><StaticImage src="../../img/okayama/company/img05.jpg" alt="" /></div>
                            <table>
                                <tbody><tr>
                                ...
                                <tr>
                                    ...
                                    <div>
                                        島根県公安委員会探偵業届出証明書番号 第71190007号<br />
                            ...
                            <div className="photo">
                            <dl>
                                <dt><StaticImage src="../../img/okayama/company/img01.jpg" alt="" /></dt>
                                <dd>
                            ...
                            <dl>
                                <dt><StaticImage src="../../img/okayama/company/img02.jpg" alt="" /></dt>
                                <dd>
                                <p className="cen blue b nm">表彰状</p>
                                </dd>
                            </dl>
                            <dl>
                                <dt><StaticImage src="../../img/okayama/company/img03.jpg" alt="" /></dt>
                                <dd>
                                <p className="cen blue b nm">組合員証</p>
                                </dd>
                            </dl>
                            <dl>
                                <dt><StaticImage src="../../img/okayama/company/img04.jpg" alt="" /></dt>
                                <dd>
                                <p className="cen blue b nm">委嘱状</p>
                                </dd>
                            </dl>
                            <dl className="dsp_smt">
                                <dt><StaticImage src="../../img/okayama/company/img05.jpg" alt="" /></dt>
                                <dd>
                            ...
                            <div className="wrap">
                                ...
                                <dl><dt>令和03年04月</dt><dd>岡山県探偵業協会副会長に就任</dd></dl>
                        ...
                        {/*div class="support">
                            ...
                            <p class="img"><StaticImage src="../../img/okayama/company/woman.png" alt=""><StaticImage src="../../img/okayama/company/man.png" alt=""></p>
                        </div*/}
                        </div>
