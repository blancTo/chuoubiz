                    ...
                    <div id={pagemeta.slug + '_sub'}>
                        <div className="main bg_wide pb">
                            ...
                            <div className="box_flex">
                                <dl>
                                <dt><StaticImage src="../../img/okayama/about/img09.jpg" alt="" /><b className="mp">企業信用調査</b></dt>
                                <dd>新しく取引を開始するにあたり、その会社の経営状態、業績、財務状況、規模、成長性、評価など会社の信用度を側面からお調べいたします。必要に応じて、代表者の人物性や風評、生活実態なども調査可能です。</dd>
                                </dl>
                                <dl>
                                <dt><StaticImage src="../../img/okayama/about/img10.jpg" alt="" /><b className="mp">採用調査</b></dt>
                                <dd>新しく従業員を採用するにあたり、会社に損害を与えるような人物ではないか、面接や履歴書などの表面上では解りにくい、隠された本当の人物性や経歴、評価、思想などを側面からお調べいたします。</dd>
                                </dl>
                                <dl>
                                <dt><StaticImage src="../../img/okayama/about/img11.jpg" alt="" /><b className="mp">市場調査</b></dt>
                                <dd>新しくお店を出店したり、開業を検討されておられる方など、交通量や場所、相乗効果などの市場性をプロの視点で情報収集し、成功するための参考資料にお役立ていただけます。</dd>
                                </dl>
                                <dl>
                                <dt><StaticImage src="../../img/okayama/about/img12.jpg" alt="" /><b className="mp">従業員の素行</b></dt>
                                ...
                                <dl>
                                <dt><StaticImage src="../../img/okayama/about/img13.jpg" alt="" /><b className="mp">危機管理</b></dt>
                                <dd>会社内での盗聴・盗撮・情報漏洩や不正アクセスなど、大きなトラブルに発展しないための危機管理を行います。</dd>
                                </dl>
                                <dl>
                                <dt><StaticImage src="../../img/okayama/about/img14.jpg" alt="" /><b className="mp">交通事故調査</b></dt>
