                ...
                <Layout>
                    <div id={pagemeta.slug} className="main">
                        ...
                        <div className="img_headline_area pt">
                            ...
                            <p className="img"><StaticImage src="../img/fingerprint/img01.jpg" alt="" /></p>
                            </div>
                            <div className="sec">
                            <div className="info">
                            ...
                            <p className="img"><StaticImage src="../img/fingerprint/img02.jpg" alt="" /></p>
                            </div>
                            <div className="sec">
                            <div className="info">
                            ...
                            <p className="img"><StaticImage src="../img/fingerprint/img03.jpg" alt="" /></p>
                            </div>
                            <div className="sec">
                            <div className="info">
                            ...
                            <p className="img"><StaticImage src="../img/fingerprint/img04.jpg" alt="" /></p>
                            </div>
                        </div>
                    </div>
                </Layout>
