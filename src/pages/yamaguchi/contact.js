                ...
                <Layout>
                    <div id={pagemeta.slug} className="main">
                        ...
                        <div id="contact_line" className="cf pb">
                            ...
                            <p>下記<Link to="https://line.me/R/ti/p/65gpK3qcDs" rel="nofollow noopener noreferrer" target="_blank">「友だち登録」</Link>をタップすると、LINEでお問い合わせができます。</p>
                            <p className="cen nm"><Link to="https://line.me/R/ti/p/%40zmg2410c"><img src="https://scdn.line-apps.com/n/line_add_friends/btn/ja.png" width={232} height={72} alt="友だち追加" /></Link></p>
                            </div>
                        </div>
                        <div id="contact_tel" className="pb">
                            ...
                            <p>お電話でのご相談の場合、下記フリーダイアルまでお問い合わせください。年中無休・24時間対応いたしております。（携帯電話からもOK）</p>
                            <div id="beginner_msg">
                        ...
                        <div className="pb">
                            ...
                            <p className="red">メールのご相談は24時間年中無休で受け付けておりますが、お急ぎの場合はフリーダイヤルへお願いいたします。</p>

                            <form action="https://ssgform.com/s/FciPQ52UaVsb" method="post" id="mailform">
