...
const about = () => {
    ...
    return (
        <>
        <Seo
            title2="調査項目｜総合探偵社中央リサーチ山口"
            description="山口の興信所・探偵社の中央リサーチ山口の調査項目について。浮気調査を最も得意とする探偵社です。ご依頼者様の心のお悩みを解決し、平穏な日々を取り戻せるよう全力を尽くします。浮気調査に多くの実績を持つ当社にお任せください。"
            keyword="調査項目,探偵,山口,興信所,浮気調査,中央リサーチ山口"
            />
            <div id="wrap">
                    ...
                    <div id={pagemeta.slug + '_sub'}>
                        <div className="main bg_wide pb">
                            ...
                            <dl id="saiban">
                                ...
                                <dd>裁判を有利に進めるために<span className="red">事実関係を立証できる有力な証拠を収集</span>します。十分な資料や証拠により、ゆとりをもって裁判に臨んでいただくための調査です。<br />
                                {/*p class="link nm"><Link to="/jirei.html#case02">調査事例はこちら</Link></p*/}</dd>
                            </dl>
                            <dl id="kekkon">
                            ...
                            <dl id="touchouki">
                                ...
                                <dd><span className="red">近年、盗聴器使用による犯罪が増えています。</span>盗聴器はインターネットや通信販売で手軽に入手出来てしまうことから、自分の知らない間に大切な個人情報が流出する危険性があります。不安や懸念のない日々のためにも、最新機器を使用し専門の調査員が盗聴器調査をいたします。<br />
                                {/*p class="link nm"><Link to="/jirei.html">調査事例はこちら</Link></p*/}</dd>
                            </dl>
                            </div>
                        </div>
                    </div>
