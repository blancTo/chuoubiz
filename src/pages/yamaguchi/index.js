        ...
        <>
            ...
            <HeaderYamaguchi h1title="山口で浮気調査なら55年の実績と信頼｜山口の探偵社、中央リサーチ山口" pagetitle="JR徳山駅前にある探偵事務所" />  
                ...
                <section id="container" className="cf">
                        ...
                        <div id="menu_sp" className="dsp_tbs yamaguchi">
                        <ul>
                        ...
                        <div id="top_menu" className="bg_wide pt pb yamaguchi">
                            ...
                            <div className="cb">
                                <h2>地元山口で、調査力<br className="dsp_smt" />No.1を誇る探偵社です｡</h2>
                        ...
                        <div id="about" className='yamaguchi'><div id="yamaguchi_about" className="bg_wide main pt pb">
                            ...
                            <p className="link nm"><Link to="/yamaguchi/jirei/">調査事例はこちら</Link></p>
                            </div></div>
                        ...
                        <div id="yamaguchi_button">
                            <p className="link mp pt pb"><Link to="/yamaguchi/voice/">お客様の声はこちら</Link></p>
                        </div>
                        ...
                        <div id="yamaguchi_point" className="bg_wide pt mb0_smp">
                            ...
                            <p className="cen_pc nm">裁判に勝つための浮気の動かぬ証拠とは、メールやSNSなどの会話の証拠ではなく裁判所が認める性的関係の立証でなくてはなりません。<br />
                                それが不貞行為です。浮気の裁判証拠として性的関係を立証できるかが一番大切なポイントになります。<br />
                                例えば2人がホテルに入る瞬間の写真や映像、その後の経過時間の記録、<br className="dsp_hp" />そして２人がホテルから出る瞬間の写真や映像などが有力な証拠となります。<br />
                                浮気相手の自宅に出入りしている場合も同様、入る瞬間と経過時間、出る瞬間などの写真や映像が有力な証拠とされています。</p>
                            </div>
                        </div>
                        <div id="top_evidence">
                        ...
                        <div id="yamaguchi_txt" className="bg_wide pt pb mp">
                            <p className="cen_pc nm">お客様の気持ちに寄り添い、一日でも早く本来の笑顔を取り戻していただくことが、<br className="dsp_hp" />私たち総合探偵社中央リサーチ山口スタッフ一同の願いです。</p>
                        </div>
                        <div id="top_faq" className="pb">
                            <h3 className="mp">浮気の問題解決を困難にしてしまう事例</h3>
                            <p>パートナーが浮気していると思われる場合の対応で最も行ってはならない事例をご紹介します。</p>
                            <div className="list">
                            <dl>
                                <dt><span>Q</span>ＧＰＳを夫（妻）の車に自身で取り付けたりしていませんか？？</dt>
                                <dd><span>A</span>浮気、素行などを疑われたら「ＧＰＳを付けられるかも？」と思われるのは当然です。ですが、夫婦といえども対象者の承諾なくＧＰＳを取り付ける行為は犯罪となります。よって、GPSをつけることはおすすめできません。</dd>
                            </dl>
                            <dl>
                                <dt><span>Q</span>パートナーに日程・予定などの行動を必要以上に細かく問いただしたりしていませんか？</dt>
                                <dd><span>A</span>実は、対象者はそれで自分が疑われている事に気づいてしまいます。こういった行為は気づかれないように浮気しなさい、とアドバイスしているのと同じ意味合いになるのです。逆に気づかないフリをし、調査依頼することをおすすめいたします。</dd>
                            </dl>
                            <dl>
                                <dt><span>Q</span>パートナーの行動を自分で調査しようと考えてはいませんか？</dt>
                                <dd><span>A</span>浮気調査は気づかれないように尾行しながら、暗闇の中でも証拠写真を撮りつつ、かつ、浮気相手の帰宅先などを割り出さないといけません。<br />
                                動かぬ証拠を取らなければ相手は認めないからです。<br />
                                一般の方がいきなり探偵まがいの事をしても、すぐに気づかれてしまい逆に警戒を高めてしまうだけです。探偵業務は高度な経験と技術が必要です。安易に動く事で二度と調査ができなくなるような行動は避けたほうが良いと思われます。</dd>
                            </dl>
                            <dl>
                                <dt><span>Q</span>携帯電話やパソコンなどに敏感になり常にチェックしすぎていませんか？</dt>
                                <dd><span>A</span>必要以上にチェックする事でその履歴が残ってしまうこともあり得ます。記録の復元ソフトなどもあり、逆に相手に悟られるケースもありますのでプロのアドバイスに従って行動される事をおすすめします。</dd>
                            </dl>
                            </div>
                        </div>
                        <div id="top_corona" className="bg_wide pt pb">
                            <h3 className="mp cen"><span>中央リサーチ山口は<br className="dsp_smt" />コロナ対策を実施しています。</span></h3>
                            <p className="b">中央リサーチ山口ではお客様の健康と安全を守るために以下の感染予防対策を実施しています。</p>
                            <div className="wrap">
                            <dl>
                                <dt>アルコール消毒液の設置</dt>
                                <dd>
